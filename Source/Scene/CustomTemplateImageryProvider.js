 ...
 *                                 specific location when {@link CustomTemplateImageryProvider#pickFeatures} is invoked.  If this
 *                                 parameter is not specified, feature picking is disabled.
 * @param {Boolean} [options.enablePickFeatures=true] If true, {@link CustomTemplateImageryProvider#pickFeatures} will
 *        request the <code>options.pickFeaturesUrl</code> and attempt to interpret the features included in the response.  If false,
 *        {@link CustomTemplateImageryProvider#pickFeatures} will immediately return undefined (indicating no pickable
 ...
 * var tms = new Cesium.CustomTemplateImageryProvider({
 ...
 * var positron = new Cesium.CustomTemplateImageryProvider({
 *     url : 'http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png',
 *     credit : 'Map tiles by CartoDB, under CC BY 3.0. Data by OpenStreetMap, under ODbL.'
 * });
 * // Access a Web Map Service (WMS) server.
 * var wms = new Cesium.CustomTemplateImageryProvider({
 ...
 */
function CustomTemplateImageryProvider(options) {
...
Object.defineProperties(CustomTemplateImageryProvider.prototype, {
    /**
     ...
     * {@link CustomTemplateImageryProvider#url} property, plus the following:
     * <ul>
     *     <li><code>{i}</code>: The pixel column (horizontal coordinate) of the picked position, where the Westernmost pixel is 0.</li>
     *     <li><code>{j}</code>: The pixel row (vertical coordinate) of the picked position, where the Northernmost pixel is 0.</li>
     *     <li><code>{reverseI}</code>: The pixel column (horizontal coordinate) of the picked position, where the Easternmost pixel is 0.</li>
     ...
     * not be called before {@link CustomTemplateImageryProvider#ready} returns true.
     * @memberof CustomTemplateImageryProvider.prototype
     * @type {Number}
     * @readonly
     * @default 256
     ...
     * This function should not be called before {@link CustomTemplateImageryProvider#ready} returns true.
     * @memberof CustomTemplateImageryProvider.prototype
     * @type {Number}
     * @readonly
     * @default undefined
     ...
     * the source of the imagery.  This function should not be called before {@link CustomTemplateImageryProvider#ready} returns true.
     * @memberof CustomTemplateImageryProvider.prototype
     * @type {Credit}
     * @readonly
     * @default undefined
 ...
 *
 * @param {Promise.<Object>|Object} options Any of the options that may be passed to the {@link CustomTemplateImageryProvider} constructor.
 */
CustomTemplateImageryProvider.prototype.reinitialize = function(options) {
    var that = this;
 ...
 */
CustomTemplateImageryProvider.prototype.getTileCredits = function(x, y, level) {
    //>>includeStart('debug', pragmas.debug);
    if (!this.ready) {
 ...
 */
CustomTemplateImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
    //>>includeStart('debug', pragmas.debug);
    if (!this.ready) {
...
function computeLongitudeLatitudeProjected(imageryProvider, x, y, level, longitude, latitude, format) {
    ...
    if (imageryProvider.tilingScheme instanceof GeographicProjection) {
